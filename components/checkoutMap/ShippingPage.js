...
const ShippingPage = () => {
  return (
    <div className="flex items-center justify-between mt-1 p-8 h-20 w-[82vw] shadow-xl rounded-md">
      ...
      <div className="flex flex-col items-center">
        <div className="rounded-[50%] animate-pulse bg-btn w-8 h-8 flex items-center justify-center">
      ...
      <div className="flex flex-col items-center">
        ...
        <h2 className="text-2xl font-bold text-gray-300">Payment Method</h2>
      </div>
      <BsArrowRight className="text-6xl text-gray-300" />
      <div className="flex flex-col items-center">
        <div className="rounded-[50%] bg-gray-400 w-8 h-8 flex items-center justify-center">
